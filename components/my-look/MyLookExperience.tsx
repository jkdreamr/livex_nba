  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-bg text-ink lg:grid lg:grid-cols-[1.18fr_0.82fr]">
      ...
      <section className="relative h-[58vh] min-h-[430px] overflow-hidden lg:h-dvh">
        ...
        <div
          className={`absolute left-1/2 top-[12.5%] z-10 aspect-[0.72/1] w-[clamp(116px,20vw,210px)] -translate-x-1/2 overflow-hidden rounded-[48%] border border-white/25 bg-[#05060b] shadow-[0_18px_70px_rgba(0,0,0,0.55)] transition lg:top-[9%] lg:w-[clamp(136px,13.2vw,220px)] ${
