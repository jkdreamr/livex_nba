...
export function HeroSection({ section }: { section: LandingSection }) {
  return (
    <section aria-label="Hero" className="relative grid min-h-dvh place-items-center px-6 text-center">
      <div data-cursor="rotate" aria-hidden="true" className="absolute inset-0" />
